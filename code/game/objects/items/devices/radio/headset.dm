...
/obj/item/device/radio/headset/headset_sec
	name = "deputy marshal's radio headset"
	desc = "This is used by the Colonial Marshal's Bureau."
...
/obj/item/device/radio/headset/headset_eng
	...
	desc = "When the engineers wish to talk about their big tools and laying pipe."
...
/obj/item/device/radio/headset/headset_sci
	...
	desc = "A science headset. Used to talk about science stuff, I guess."
...
/obj/item/device/radio/headset/heads/captain
	name = "mission commander's headset"
	desc = "What are you looking at? It's just a headset"
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/captain

/obj/item/device/radio/headset/heads/headset_ce
	name = "chief engineer's headset"
	desc = "The headset of the guy who is in charge of morons."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/headset_ce
...
/obj/item/device/radio/headset/heads/headset_marshal
	name = "colonial marshal's headset"
	desc = "The headset of the man who protects your worthless lives."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/marshal

/obj/item/device/radio/headset/heads/headset_ca
	name = "colonial administrator's headset"
	desc = "As your gaze meets this headset, you feel comepelled to fill out paperwork"
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/headset_ca
...
/obj/item/device/radio/headset/heads/headset_scio
	name = "science officer's headset"
	desc = "Beep boop computers and medical shit"
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/headset_scio

/obj/item/device/radio/headset/headset_colonist
	name = "colonist's headset"
	desc = "This is the bane of your existance.  Everyone's always shouting at you through it."
	icon_state = "headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/headset_colonist
...
/obj/item/device/radio/headset/headset_surv
	name = "surveyor's headset"
	desc = "A handy device to keep in contact when exploring new worlds"
	icon_state = "com_headset"
	item_state = "com_headset"
	ks2type = /obj/item/device/encryptionkey/headset_surv

/obj/item/device/radio/headset/headset_mining
	name = "miner's headset"
	desc = "miner's headset"
	icon_state = "cargo_headset"
	item_state = "cargo_headset"
	ks2type = /obj/item/device/encryptionkey/headset_mining
