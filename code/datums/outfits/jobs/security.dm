...
/decl/hierarchy/outfit/job/security/hos
	name = OUTFIT_JOB_NAME("Colonial Marshal") //Head of Security
...
/decl/hierarchy/outfit/job/security/officer
	name = OUTFIT_JOB_NAME("Deputy Marshal")	//Security Officer
	uniform = /obj/item/clothing/under/rank/depmarshal
